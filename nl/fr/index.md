...
* [Installez l'interface de ligne de commande {{site.data.keyword.Bluemix_notm}}](https://console.bluemix.net/docs/cli/reference/bluemix_cli/get_started.html#getting-started){:new_window} afin de pouvoir interagir avec {{site.data.keyword.Bluemix_notm}} depuis la ligne de commande. 
